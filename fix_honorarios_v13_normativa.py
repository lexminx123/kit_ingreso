"""
fix_honorarios_v13_normativa.py — Versión 1.3 de los contratos de honorarios.
Añade una nueva cláusula sobre MARCO NORMATIVO APLICABLE Y CERTIFICACIONES
REQUERIDAS, que enumera:
  ...
  - INHRR "Rafael Rangel" y Órganos de Sanidad
  - RESQUIMC (Registro Nacional Único de Operadores de Sustancias Químicas Controladas)
  - Ley Orgánica de Drogas

También añade que el profesional debe estar certificado por todas las
instituciones que correspondan, y en caso de no estarlo, la
responsabilidad es personal del profesional.
"""
import os, sys
...
# ============================================================
# Función auxiliar: renderiza la cláusula de MARCO NORMATIVO
# ============================================================
def render_clause_marco_normativo(doc, es_veterinario=True):
    add_section(doc, "CLÁUSULA DÉCIMA SEXTA: MARCO NORMATIVO APLICABLE Y CERTIFICACIONES REQUERIDAS")

    add_para(doc,
        "EL PROFESIONAL declara conocer, aceptar y obligarse a cumplir estrictamente, en "
        "el ejercicio de los servicios objeto del presente contrato, todas las normas "
        "siguientes, así como las demás leyes, reglamentos, resoluciones y normas "
        "técnicas que las complementen o reformen, vigentes en la República Bolivariana "
        "de Venezuela:",
        size=10, space_after=4)

    # Lista de leyes aplicables
    add_bullet(doc,
        "Ley de Ejercicio de la Medicina Veterinaria (1968) — Establece las normas para "
        "el ejercicio profesional de los médicos veterinarios, incluyendo sus deberes "
        "en la protección de la salud animal y el control de tratamientos y fármacos. "
        "El profesional veterinario debe estar inscrito y vigente en el Colegio de "
        "Médicos Veterinarios de Venezuela (CMV).",
        bold_lead="1.  ", size=9)

    add_bullet(doc,
        "Ley de Medicamentos (2000) — Regula la política farmacéutica nacional, "
        "abarcando los controles sobre fabricación, importación, distribución y uso "
        "racional de productos farmacéuticos. Aplica al manejo, prescripción y "
        "dispensación de medicamentos veterinarios en la clínica.",
        bold_lead="2.  ", size=9)

    add_bullet(doc,
        "Ley para la Protección de la Fauna Doméstica Libre y en Cautiverio (2010) — "
        "Define el marco de bienestar y protección para los animales domésticos, lo cual "
        "se relaciona con la responsabilidad profesional en su atención médica, manejo, "
        "contención y bienestar. EL PROFESIONAL se obliga al trato ético y libre de "
        "crueldad de los animales bajo su cuidado.",
        bold_lead="3.  ", size=9)

    add_bullet(doc,
        "Normas del Instituto Nacional de Higiene \"Rafael Rangel\" (INHRR) y de los "
        "Órganos de Sanidad — Participan en la regulación de registros, normativas de "
        "comercialización y control de productos farmacéuticos y biológicos en territorio "
        "nacional. EL PROFESIONAL debe asegurar que los medicamentos y biológicos que "
        "maneje cuenten con los registros sanitarios correspondientes.",
        bold_lead="4.  ", size=9)

    add_bullet(doc,
        "RESQUIMC (Registro Nacional Único de Operadores de Sustancias Químicas "
        "Controladas) — Servicio desconcentrado del Estado venezolano encargado de "
        "regular y controlar todas las actividades con sustancias químicas que puedan "
        "usarse para fabricar drogas ilícitas. Controla operaciones de producción, "
        "almacenamiento, comercialización, importación, exportación, transporte y "
        "desechos de químicos controlados. Aplica a personas naturales y jurídicas. "
        "Las licencias tienen vigencia de 12 meses y deben renovarse 60 días antes de "
        "vencer. Las solicitudes de importación o exportación se gestionan con 20 días "
        "hábiles de anticipación. EL PROFESIONAL debe cumplir los lineamientos RESQUIMC "
        "para el manejo de sustancias químicas controladas en la clínica veterinaria.",
        bold_lead="5.  ", size=9)

    add_bullet(doc,
        "Ley Orgánica de Drogas — Régimen que rige, junto con los convenios "
        "internacionales antinarcóticos suscritos por Venezuela, el control y "
        "fiscalización de sustancias químicas controladas, estupefacientes y "
        "psicotrópicos. EL PROFESIONAL que manipule sustancias controladas (ketamina, "
        "opioides, benzodiacepinas, anestésicos) debe cumplir estrictamente con la "
        "cadena de custodia, registro en libro foliado, almacenamiento con doble "
        "cerradura, reporte de pérdidas o robos, y demás previsiones de la normativa.",
        bold_lead="6.  ", size=9)

    if es_veterinario:
        add_bullet(doc,
            "Norma Técnica NT-01-2008 (Sustancias, Materiales y Procesos Peligrosos) y "
            "NT-02-2008 (Vigilancia de la Salud de los Trabajadores) — Aplicables a las "
            "condiciones de bioseguridad y vigilancia médica del profesional en la "
            "clínica veterinaria.",
            bold_lead="7.  ", size=9)

        add_bullet(doc,
            "Ley Orgánica de Prevención, Condiciones y Medio Ambiente de Trabajo "
            "(LOPCYMAT) — En lo concerniente a las condiciones de seguridad y salud "
            "del profesional en las instalaciones de LA EMPRESA, sin que ello implique "
            "relación laboral.",
            bold_lead="8.  ", size=9)
    else:
        add_bullet(doc,
            "Norma Técnica NT-01-2008 (Sustancias, Materiales y Procesos Peligrosos) — "
            "Aplicable a las condiciones de bioseguridad del profesional en el área de "
            "peluquería canina (manejo de animales, fluidos, químicos de higiene).",
            bold_lead="7.  ", size=9)

    add_para(doc,
        "CERTIFICACIONES Y PERMISOS: EL PROFESIONAL declara y garantiza que cuenta con "
        "todas las certificaciones, permisos, licencias, registros y autorizaciones "
        "exigidas por las autoridades competentes para el ejercicio de la profesión y "
        "para el manejo de las sustancias, equipos y procedimientos propios del servicio "
        "objeto del presente contrato, incluyendo pero no limitado a: inscripción en el "
        "CMV (para veterinarios), RIF personal vigente, permisos sanitarios del INHRR, "
        "inscripción en RESQUIMC cuando corresponda, y demás permisos que la normativa "
        "exija para el ejercicio profesional veterinario y para el manejo de sustancias "
        "químicas y farmacéuticas controladas.",
        size=10, bold=True, space_before=4, space_after=4)

    add_para(doc,
        "RESPONSABILIDAD PERSONAL POR CERTIFICACIONES: EL PROFESIONAL declara y acepta "
        "que el mantenimiento de todas las certificaciones, permisos, licencias, "
        "registros y autorizaciones exigidas por la normativa aplicable es "
        "RESPONSABILIDAD EXCLUSIVA Y PERSONAL DEL PROFESIONAL. LA EMPRESA no asume "
        "ninguna responsabilidad por la falta, vencimiento, suspensión, revocatoria o "
        "inexistencia de las certificaciones del PROFESIONAL. En caso de que EL "
        "PROFESIONAL preste servicios sin estar al día con sus certificaciones, "
        "licencias o permisos, o los preste en violación de la normativa aplicable, "
        "LA EMPRESA queda exenta de cualquier responsabilidad civil, penal, "
        "administrativa, fiscal o sanitaria que se derive de tal incumplimiento, y "
        "EL PROFESIONAL asumirá personalmente, frente a LA EMPRESA, a los clientes, "
        "a los propietarios de las mascotas y a las autoridades competentes, todas las "
        "consecuencias jurídicas, sancionatorias, indemnizatorias y reparadoras que "
        "tales incumplimientos generen, incluyendo multas, clausuras, decomisos, "
        "suspensiones, demandas y cualquier otro tipo de sanción o perjuicio. "
        "Asimismo, EL PROFESIONAL indemnizará a LA EMPRESA por los daños y perjuicios "
        "que esta pudiera sufrir como consecuencia de los incumplimientos del "
        "PROFESIONAL en materia de certificaciones y permisos.",
        size=10, italic=True, color=GRAY_TEXT, space_after=4)

    add_para(doc,
        "OBLIGACIÓN DE INFORMAR: EL PROFESIONAL se obliga a informar de inmediato a "
        "LA EMPRESA sobre cualquier vencimiento, suspensión, revocatoria, "
        "modificación o novedad que afecte sus certificaciones, permisos o licencias. "
        "El incumplimiento de esta obligación de información constituye falta grave "
        "del presente contrato y facultará a LA EMPRESA a resolverlo conforme a la "
        "Cláusula Décima Primera.",
        size=10, space_after=6)


# ============================================================
# 1. CONTRATO HP VETERINARIO v1.3
# ============================================================
def gen_contrato_hp_vet_v13():
    ...
    # ===== CLÁUSULA 3: JORNADAS Y GUARDIAS =====
    ...
    # ===== CLÁUSULA 4: HONORARIOS Y FORMA DE PAGO =====
    ...
    add_bullet(doc, "Resolución inmediata por causa grave (mala praxis profesional, violación de confidencialidad, abandono de servicios, no disponibilidad injustificada para emergencias, publicación no autorizada en redes sociales, incumplimiento de la normativa del Art. 16 o falta de certificaciones vigentes).")
    add_para(doc,
    ...
    add_para(doc,
        ...
        "naturaleza civil y mercantil.", space_after=6)

    # ===== CLÁUSULA 16: MARCO NORMATIVO APLICABLE Y CERTIFICACIONES (NUEVA) =====
    render_clause_marco_normativo(doc, es_veterinario=True)
    ...
    add_footer(section, "Contrato Honorarios Médico Veterinario v1.3")
...
# ============================================================
# 2. CONTRATO HP DOG GROOMER v1.3
# ============================================================
def gen_contrato_hp_groomer_v13():
    ...
    # ===== CLÁUSULA 3: JORNADAS Y DISPONIBILIDAD =====
    add_section(doc, "CLÁUSULA TERCERA: JORNADAS, GUARDIAS Y DISPONIBILIDAD")
    add_para(doc,
        "Las partes acuerdan que EL PROFESIONAL prestará sus servicios bajo jornadas "
    ...
    add_bullet(doc, "Resolución inmediata por causa grave (maltrato animal, robo, violación de confidencialidad, no disponibilidad injustificada para emergencias, publicación no autorizada en redes sociales, incumplimiento de la normativa del Art. 14 o falta de certificaciones vigentes).")
    add_para(doc,
    ...
    add_para(doc,
        ...
        "someterse. Se excluye expresamente la jurisdicción laboral.", space_after=6)

    # ===== CLÁUSULA 15: MARCO NORMATIVO APLICABLE Y CERTIFICACIONES (NUEVA) =====
    render_clause_marco_normativo(doc, es_veterinario=False)
    ...
    add_signature_block(doc, ["LA EMPRESA", "EL PROFESIONAL"])
    add_footer(section, "Contrato Honorarios Dog Groomer v1.3")
...
if __name__ == "__main__":
    print("Generando contratos HP v1.3 con marco normativo + certificaciones...")
    outs = [
        gen_contrato_hp_vet_v13(),
        gen_contrato_hp_groomer_v13(),
    ]
    for o in outs:
        size_kb = os.path.getsize(o) / 1024
        print(f"  ✓ {o}  ({size_kb:.1f} KB)")
    print("\nContratos HP v1.3 generados correctamente.")
